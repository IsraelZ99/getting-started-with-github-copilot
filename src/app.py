...
activities = {
    ...
    "Basketball Club": {
        "description": "Competitive basketball team and casual play",
    ...
    "Soccer Club": {
        "description": "Competitive soccer team and league matches",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
        "participants": ["tyler@mergington.edu", "grace@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Competitive swimming and diving for all levels",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["sophia@mergington.edu"]
    },
    "Music Club": {
        "description": "Orchestral and chamber music performances with ensemble practice",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 24,
        "participants": ["marcus@mergington.edu", "claire@mergington.edu"]
    },
    "Photography Club": {
        "description": "Digital and film photography with editing and exhibition opportunities",
    ...
    "Math Club": {
        "description": "Problem-solving and competition mathematics for all skill levels",
